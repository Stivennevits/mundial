                        ...
                        <tbody>
                            ...
                            %>
                                    <tr>
                                        ...
                                        <td>
                                            <a  style="color: white;" onclick="mostrarImagenEquipo(<%= equipo.getId() %>, '<%= equipo.getBandera() %>')" title="Ver equipo"><i class='fas fa-flag' style="color: red;"></i></a>
                                        </td>
                                        <td><a  onclick="verJugador(<%= equipo.getId()%>)" title="Ver Jugadores"><i class="fas fa-clipboard-list"></i></a></td>
                                        <td><a  onclick="abrirReporteNomina(<%= equipo.getId()%>)" title="Calcular NÃ³mina" href="reporte.jsp?idEquipo=<%= equipo.getId()%>"><i class="fas fa-dollar-sign" style="color: green;"></i></a></td>
                                        <td><a  data-bs-toggle="modal" data-bs-target="#editarModal<%= equipo.getId()%>" title="Editar"><i class="fas fa-pencil-alt" style="color: yellow;"></i></a></td>
                                        <td class="action">
                                            <a href="eliminarEquipo.do?id=<%= equipo.getId()%>" onclick="return confirmarEliminar();" title="Eliminar"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <% } %>
                            <% } %>
