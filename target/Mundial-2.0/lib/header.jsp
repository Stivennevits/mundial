...
.navbar {
            background-color: #4CAF50; /* Cambiado a un color más llamativo */
            padding: 10px 20px;
        }
        ...
        .navbar-brand {
            ...
            text-transform: uppercase;
            text-align: center;
            font-family: 'Pacifico', cursive; /* Cambiado a una letra más bonita y elegante */
            transition: all 0.3s;
        }
...
<body>
    ...
    <div class="container">
        <a class="navbar-brand" href="index.jsp">
            Mundial <span style="color: #FFD232;">FIFA 2026</span>
        </a>
